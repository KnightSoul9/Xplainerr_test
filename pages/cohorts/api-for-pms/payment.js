          ...
          <div className="relative mx-auto max-w-3xl px-4 text-center">
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-2xl font-medium text-gray-800">
                {`You're`} shortlisted for APIs For PM cohort
              </p>
            ...
            <div className="lg:w-1/2">
              <div className="rounded-2xl bg-gradient-to-br from-[#1a1f35] to-[#030a21] p-8 text-white shadow-xl">
                <h2 className="text-3xl font-bold leading-tight text-gradient bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-teal-400">
                  Top Tech Companies That Value API Knowledge
                </h2>
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-6 space-y-4">
                    {[
                      ...
                      'PMs with technical knowledge are 37% more likely to transition into leadership role',
                      'APIs are the bread and butter of modern software development',
                      'Sundar Pichai was a tech PM who built Google Chrome browser'
                    ].map((point, index) => (
